        ...
        switch (opt) {
            case Kint:{        /* signed integers */
                    ...
                    if (size < SZINT) { /* need overflow check? */
                        lua_Integer lim =
                            (lua_Integer) 1 << ((size * NB) - 1);
                        luaL_argcheck(L, -lim <= n
                                      && n < lim, arg, "integer overflow");
                    }
...
static int str_unpack(lua_State * L)
{
    ...
    while (*fmt != '\0') {
        ...
        switch (opt) {
            ...
            case Kuint:{
                    lua_Integer res =
                        unpackint(L, data + pos, h.islittle, size,
                                  (opt == Kint));
            ...
            case Kfloat:{
                    ...
                    copywithendian((char *)&f, data + pos, sizeof(f),
                                   h.islittle);
